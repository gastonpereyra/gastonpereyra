...
> <p align="center">{{WEATHER_PLACE}} ({{WEATHER_PROVINCE}}) :earth_americas: | {{WEATHER_TEMP}} {{WEATHER_TEMP_COLOR}} | {{WEATHER_DESC}} {{WEATHER_ICON}} | {{WEATHER_WIND}} km/h :wind_chime: {{WEATHER_WDIR}} {{WEATHER_WDIR_ICON}}</p>
